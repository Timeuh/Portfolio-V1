import one from '../../public/progress/1-clear.png';
import next from '../../public/progress/next.png';
import two from '../../public/progress/2-current.png';
    ...
    return (
        <div className={'h-full w-full bg-martinique-300 flex flex-col items-center xl:h-screen'}>
            ...
            <div className={'w-full flex flex-col items-center xl:flex-row xl:h-1/2'}>
                <div className={'w-full h-1/5 flex flex-col items-center justify-between space-y-4 px-8 text-center text-green-700'}>
