...
function About() {
    ...
    return (
        <div id="about" className="w-full bg-thunder-800 text-fuel-yellow-main text-xl h-full
            2xl:bg-[url('/backgrounds/about-bg.png')] 2xl:bg-cover">
            <div className="flex 2xl:flex-row flex-col justify-around items-center h-1/4 py-8">
                <img src={picture} height="300" width="300" alt="me"
                     className="rounded-full border-2 border-fuel-yellow-main"/>
                <p className="2xl:w-2/6 w-3/4 pt-8 leading-8 2xl:pl-24 ">
            ...
            <div className="flex 2xl:flex-row-reverse flex-col justify-around items-center h-1/4 pb-12">
                <img src={graduation} height="300" width="300" alt="graduation"
                     className="rounded-full border-2 border-monza-main"/>
                <p className="2xl:w-2/6 py-8 leading-8 w-3/4">
            ...
            <div className="flex 2xl:flex-row flex-col justify-around items-center h-1/4 py-8">
                <img src={frameworks} height="300" width="300" alt="frameworks"
                     className="rounded-full border-2 border-monza-main"/>
                <p className="2xl:w-2/6 pt-8 leading-8 2xl:pl-24 w-3/4">
            ...
            <div className="flex 2xl:flex-row-reverse flex-col justify-around items-center h-1/4 py-8">
                <img src={webapp} height="300" width="300" alt="web app"
                     className="rounded-full border-2 border-fuel-yellow-main"/>
                <p className="2xl:w-2/6 pt-8 leading-8 w-3/4">
